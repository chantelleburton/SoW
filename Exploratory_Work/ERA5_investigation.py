...
COUNTRY_CONFIG = {
    'Korea': {
        ...
        'file_patterns': {
            ...
            '10m-u-wind': '/data/scratch/bob.potts/sowf/ERA5_Checks/10m-U-wind/daily_mean/era5_daily_mean_10m_u_component_of_wind_199*.nc',
        },
        'plot_titles': {
            ...
            '10m-u-wind': 'ERA5 Daily Mean 10m U Wind 1990s Korea',
        },
        'plot_filenames': {
            'temperature': 'mean_March_monthly_era5_daily_mean_2m_temperature_korea.png',
            'precipitation': 'mean_March_monthly_era5_sum_total_precipitation_korea.png',
            'relative_humidity': 'mean_March_monthly_era5_relative_humidity_korea.png',
            '10m-u-wind': 'mean_March_monthly_era5_10m_u_wind_korea.png',
        },
        'plot_labels': {
            'temperature': 'Mean 2m Temperature (K)',
            'precipitation': 'Total Precipitation (mm)',
            'relative_humidity': 'Mean Relative Humidity (%)',
            '10m-u-wind': 'Mean 10m U Wind (m/s)',
        },
    },
    'Scotland': {
        ...
        'plot_titles': {
            ...
            '10m-u-wind': 'ERA5 Daily Mean 10m U Wind 1990s Scotland',
        },
        'plot_filenames': {
            'temperature': 'mean_July_monthly_era5_daily_mean_2m_temperature_scotland.png',
            'precipitation': 'mean_July_monthly_era5_sum_total_precipitation_scotland.png',
            'relative_humidity': 'mean_July_monthly_era5_relative_humidity_scotland.png',
            '10m-u-wind': 'mean_July_monthly_era5_10m_u_wind_scotland.png',
        },
        'plot_labels': {
            'temperature': 'Mean 2m Temperature (K)',
            'precipitation': 'Total Precipitation (mm)',
    ...
    'Iberia': {
        ...
        'plot_titles': {
            ...
            '10m-u-wind': 'ERA5 Daily Mean 10m U Wind 1990s Iberia',
        },
        'plot_filenames': {
            ...
            '10m-u-wind': 'mean_monthly_era5_10m_u_wind_iberia.png',
        },
        'plot_labels': {
            'temperature': 'Mean 2m Temperature (K)',
            'precipitation': 'Total Precipitation (mm)',
...
def process_era5(variable, config):
    ...
    for f in files:
        ...
        #print(cube.coords('valid_time'))

        if cube.coords('time'):
            cube = cube.extract(iris.Constraint(time=lambda cell: cell.point.month in months))
        elif cube.coords('valid_time'):
            cube = cube.extract(iris.Constraint(valid_time=lambda cell: cell.point.month in months))
        else:
            raise ValueError("No suitable time coordinate found in cube!")
        #print(cube)
        if cube is None:
            print(f"Warning: No data for selected months in file {f}. Skipping.")
            continue
    ...
    if not sorted_data:
        print(f"No data available for variable '{variable}' and selected months in region '{config['region_name']}'. Skipping plot.")
        return
...
# ================== CONFIGURATION ==================
Country = 'Korea'  # Options: 'Korea', 'Scotland', 'Iberia'

config = COUNTRY_CONFIG[Country]
# for variable in ['temperature', 'precipitation', 'relative_humidity']:
for variable in ['10m-u-wind']:
