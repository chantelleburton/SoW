...
#Get the ERA5 2025 data for the threshold line
    ...
    print(f"ERA5 2025 {Country} FWI {month} {percentile}th percentile: {ERA5_2025:.2f}")
    return ERA5_2025
...
for histmember in np.arange(10,11): #TEST
    ...
    df_obs = pd.read_csv(baseline_folder+'ERA5_FWI_1960-2013_'+Country+'_'+str(percentile)+'%.dat')#This is the historical ERA5 array made in Historical_FWI.py/ Supplement.py
...
Countries = ('Iberia', 'Korea', 'Scotland')
n = 1
