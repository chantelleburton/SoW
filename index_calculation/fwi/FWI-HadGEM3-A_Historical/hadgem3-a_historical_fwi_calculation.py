...
if __name__ == '__main__':
    ...
    hurs = hurs.clip(min=0, max=100)  # clip to [0,100] to avoid NaN in FFMC calculation
    ...
    for idx_name in OUTPUT_INDICES:
        ...
        out_path = os.path.join(out_dir, f'hadgem3a_{idx_name}_historical_{member}_{START_YEAR}-{END_YEAR}_modified.nc')
        chunksizes = tuple(
