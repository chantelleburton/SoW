...
###end of cylc based config###

###regular config###
shp_file = '/data/users/chantelle.burton/Attribution/StateOfFires_2025-26/SoW2526_Focal_MASTER_20260218.shp'
output_dir = '/data/scratch/bob.potts/sowf/fwi-calculation-pipeline/Bias_corrected_output'
baseline_folder = '/data/scratch/bob.potts/sowf/fwi-calculation-pipeline/Historical_Metrics' #path to csvs of historical period fwi95/metrics.
...
DATA_YEARS = [2020, 2021, 2022, 2023, 2024] #default anchor years for bias correction.
...
#Set up the regions, this could be moved to a better config.
...
if Country == 'Iberia':
    ...
    DATA_YEARS = [2021, 2022, 2023, 2024]  # Prevents january/febuary 2020 within the spinup period from being used.
    ...
    raise ValueError(f"Unknown Country: {Country}. Expected one of: Iberia, Chile, Canada")
...
#### SoftLog transform the data here ####
